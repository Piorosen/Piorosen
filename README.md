...
|기간|종류|활동 내용|비고|
|:----:|:-----:|:----:|:----:|
|04.14 ~ 05.10|외주|MES 시스템 중 웹에서 인식 가능한 바코드 리더기, 프린터기 모듈 구현, iFrame을 이용한 크롬의 탭과 같은 멀티 |[바코드 리더기](https://github.com/Piorosen/javascript-barcode-image), [프린터기](https://github.com/Piorosen/toshiba-fv4t-printer)|
